# s3-cache-action
This action is a scratch implementation of a cache action that caches files to Amazon S3.
...
Refer to [actions.yaml](https://github.com/itchyny/gojq/blob/main/actions.yaml) for the full documentation.
